    ...
    <footer class="mt-14">
      ...
      <div class="flex flex-col gap-[16px] mt-[32px] sm:flex-row sm:justify-between sm:gap-6 sm:mt-[56px]">
        <div class="flex flex-col gap-[5px]">
          <a href="/contact-us.html" class="text-[#BCBCBC] font-normal hover:text-white text-[14px]">Contact</a>
          <a href="/generic.html" class="text-[#BCBCBC] font-normal hover:text-white text-[14px]">Return Policy / Disclaimer</a>
          <a href="/pricing.html" class="text-[#BCBCBC] font-normal hover:text-white text-[14px]">Pricing</a>
        </div>
        <div>
