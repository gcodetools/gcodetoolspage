    ...
    <header class="flex flex-col pt-5 mb-[10px]">
      <div class="flex gap-[100px] justify-between mb-[10px] h-[71px] md:h-auto">
        <div class="lg:min-w-[256px]">
          <h1 class="w-[150px] select-none">
            <a href="/" class="select-none">
              <img src="../assets/GTNEW_Logo_Seal.svg" alt="GTLogo" class="select-none" />
            </a>
          </h1>
        </div>
        ...
        <nav class="hidden md:flex md:justify-between md:flex-1">
          <a href="/" class="text-[#BCBCBC] hover:text-white font-normal text-[14px]">Home</a>
          <div class="products-selector flex flex-col gap-[5px] min-w-[123px]"></div>
          <a href="/pricing.html" class="text-[#BCBCBC] hover:text-white font-normal text-[14px]">Pricing</a>
          <a href="/contact-us.html" class="text-[#BCBCBC] hover:text-white font-normal text-[14px]">Contact Us</a>
  ...
  rel="noopener noreferrer"><img src="../assets/instagram.svg" alt="instagram-icon" /></a>
        ...
        <div class="md:hidden">
          <button id="menu-toggle" aria-label="Abrir menú">
            <img src="../assets/menu.svg" alt="menu-icon" class="w-7 h-7" />
          </button>
        </div>
      </div>
      ...
      <div id="mobile-menu" class="hidden fixed inset-0 flex flex-col gap-[45px] bg-[#161616] p-[20px] z-50">
        ...
        <a href="/" class="text-[#BCBCBC] hover:text-white text-[20px]">Home</a>
        <div class="products-selector products-selector-large flex flex-col gap-[5px] min-w-[123px]"></div>
        <a href="/pricing.html" class="text-[#BCBCBC] hover:text-white text-[20px]">Pricing</a>
        <a href="/contact-us.html" class="text-[#BCBCBC] hover:text-white text-[20px]">Contact Us</a>
        <a   href="https://www.instagram.com/gcodetools/reels/" 
  target="_blank" 
