// routes.js
const productRoutes = [
  { label: "Clay Slicer", path: "/product/clay-slicer.html" },
  { label: "Vector to Gcode", path: "/product/vector-to-gcode.html" },
  { label: "Gcode Cloner", path: "/product/gcode-cloner.html" },
];
